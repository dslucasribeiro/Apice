        ...
        <div className="mb-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <div className="flex gap-4 items-center">
              <div>
                <label className="block text-gray-300 text-sm mb-1">Data Inicial</label>
                <input
                  type="date"
                  value={startDate}
              ...
              <div>
                <label className="block text-gray-300 text-sm mb-1">Data Final</label>
                <input
                  type="date"
                  value={endDate}
            ...
            {userType.toLowerCase() === 'admin' && (
              <button
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-150 ease-in-out transform hover:scale-105 ml-auto"
